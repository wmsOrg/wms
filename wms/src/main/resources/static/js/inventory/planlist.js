layui.use(['table','form', 'jquery', 'laydate', 'layer', 'laypage', 'dialog', 'element', 'upload', 'layedit'], function() {
                ...
                if (result.code == "9") {
                    ...
                    for (var i = 0; i < length; i++){
                        ...
                        var divhtml = "<form class=\"layui-form\">\n" +
                            ...
                            "                    </div>\n" +
                            "                    <a class=\"template store-list-box\" onclick='infoScheme(\""+divData.id+"\",\""+divData.alarmingId+"\",\""+divData.schemeId+"\");return false;'  href=\"javascript:;\"> <img class=\"store-list-cover\" src=\""+imageUrl+"\"> <h2 class=\"layui-elip\">"+divData.planName+"</h2>\n" +
                            "                    </a>\n" +
                            "                </div>\n" +
                            "            </form>";
                        divHtmls += divhtml;
    ...
    window.infoScheme = function (planId,alarmingId,schemeId) {
        if (alarmingId == null || alarmingId == ""){
            ...
            var url="/wms/toInventoryList?planId="+planId+"&alarmingId="+alarmingId+"&schemeId="+schemeId;
