...
function gridSystemGenerator() {
    $(".lyrow .preview input").bind("keyup", function() {
        ...
        // $.each(n, function(n, r) {
        //     e = e + parseInt(r);
        //     t += '<div class="span' + r + ' column"><a href="#close" style="position: absolute;top: 2px; right:2px;" class="label label-important"><i class="icon-edit icon-white"></i>编辑</a></div>'
        // });
        // if (e == 12) {
        //     $(this).parent().next().children().html(t);
        //     $(this).parent().prev().show();
...
$(document).ready(function() {
    ...
    //     window.demoHtml = layouthistory.list[layouthistory.count-1];
    layouthistory = null;
        if (window.demoHtml) $(".demo").html("");
    // }

    var contenthandle = CKEDITOR.replace( 'contenteditor' ,{
        language: 'zh-cn',
        contentsCss: ['../static/css/visibleEditLayout/bootstrap-combined.min.css'],
        allowedContent: true
    });
    $("body").css("min-height", $(window).height() - 90);
    $(".demo").css("min-height", $(window).height() - 160);
