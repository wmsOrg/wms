package com.hczx.wms.framework.config.shiro;
...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		//查询用户的权限
		UserAllPermissionEntity permission = (UserAllPermissionEntity) session.getAttribute(Constants.SESSION_USER_PERMISSION);
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
		...
		UserModel user = authenticationService.getUser(loginName, password);
		if (user == null) {
			//没找到帐号
